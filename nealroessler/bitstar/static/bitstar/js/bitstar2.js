...
function init() {
    ...
    donateImage.style.top = 450 + 'px';
    donateImage.style.color = "white";
    donateImage.innerHTML = '<p>Buy me a coffee: </p> <img src="/static/bitstar/js/donate" alt="donate: 1JJYdHcbHpSLuG1aygsdZwUcvGvN41SPWy" style="width:150;height:150;">'
